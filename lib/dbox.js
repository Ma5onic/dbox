  ...
  return {
    ...
    client: function(options){
      ...
      return {
        ...
        oauth2_token: function(cb){
          var signature = helpers.sign(options)
          var args = {
            "method": "POST",
            "headers": { "content-type": "application/x-www-form-urlencoded" },
            "url": "https://api.dropbox.com/1/oauth2/token_from_oauth1",
            "body": qs.stringify(signature)
          }
          return request(args, function(e, r, b){
            cb(e ? null : r.statusCode, e ? null : helpers.parseJSON(b))
        ...
        put_stream: function(path, length, args, cb){
          if(!cb){
            cb   = args
            args = null
          }
          ...
          if (length) args.headers = { "content-length": length }

          return request(args, function(e, r, b){
            cb(e, e ? r : helpers.parseJSON(b))
          })
        },
